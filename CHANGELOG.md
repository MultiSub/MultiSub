...
- Added Netflix popup display settings and native-menu second-track selection, matched-style rendering, fullscreen overlays, and local debug snapshots.
...
- Kept Netflix second-track selection exclusively in the injected native-menu column instead of duplicating it in the popup.
